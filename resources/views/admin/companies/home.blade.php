...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{!! trans('admin.Companies Account') !!}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class=""><a href="{!! aurl() !!}">{!! trans('admin.Dashboard') !!}</a> /</li>
                            <li class="active">{!! trans('admin.Companies Account') !!}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
    ...
    {!! Form::open(['url' => aurl('companies/destroy/all'),'id'=>'form_delete','method'=>'delete']) !!}
    <div id="len_sta_dataTable_button">
